...
<html>
  ...
  @media screen and (max-width: 450px) {
    ...
    .background-image {
      ...
      background-image: url(https://media.licdn.com/mpr/mpr/AAEAAQAAAAAAAAgkAAAAJDgwNTIwNWI5LWE5ZTQtNDZhZS1hZmYzLTc4YmZhYzY5YTA1Mg.png) !important;
    }
  ...
  <div class="content-container shadow">
    ...
    <div class="subheader primary-text-color">
      Упсс, запрашиваемая страница не существует
    </div>
    <div class="hr"></div>
    <div class="context secondary-text-color">
      <p>
        Ты можешь вернуться на главную. <br>
        Если ты считаешь, что что-то не работает, сообщи нам об ошибке.
      </p>
    </div>
    <div class="buttons-container">
      <a class="button" href="/" target="_blank"><span class="fa fa-home"></span> Главная</a>
      <a class="button" href="https://vk.com/kalemb" target="_blank"><span class="fa fa-warning"></span> Напиши нам</a>
    </div>
  </div>
</center>
